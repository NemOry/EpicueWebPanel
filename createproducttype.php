...
<div class="container-fluid">
  <div class="row-fluid">
    ...
    <div class="span6 well" style="max-height:600px; height:600px; overflow:scroll;">
      <legend>
          Product Types <button onclick="loadtable(); return false;" class="btn btn-mini btn-success"><i class="icon-large icon-refresh icon-white"></i></button> <span id="loading" class="label">Loading...</span>
      </legend>
  ...
  function loadtable()
  {
    ...
    $.ajax(
    {
      url: 'includes/webservices/gettable.php?itemtype=producttype&input='+$("#tablesearch").val(),
  ...
  $(document).on("click", ".btndelete", function()
  {
    ...
    {
      type: 'get',
      url: 'includes/webservices/delete.php?itemid='+id+'&itemtype=producttype',
      success: function(result) 
      {
        loadtable();
      }
  ...
  { 
    ...
    $("#btncreate").click(function()
    {
      ...
      {
        type: 'POST',
        url: 'includes/webservices/createproducttype.php',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
