              ...
              else
              {
                echo '
                    <ul class="nav">
                      ...
                      <li id="apiexplorer"><a href="apiexplorer.php"><i class="icon-large icon-lock icon-white"></i> API Explorer</a></li>
                      <li id="documentation"><a href="documentation.php"><i class="icon-large icon-lock icon-white"></i> Documentation</a></li>
                      <li id="createdropdown" class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                          <li><a href="createstore.php"><i class="icon-large icon-bookmark"></i> Stores</a></li>
                          <li><a href="createstoretype.php"><i class="icon-large icon-leaf"></i> Store Types</a></li>
                          <li class="divider"></li>
                          <li><a href="createproduct.php"><i class="icon-large icon-shopping-cart"></i> Products</a></li>
                          <li><a href="createproducttype.php"><i class="icon-large icon-leaf"></i> Product Types</a></li>
                          <li class="divider"></li>
                          <li><a href="createfeatureditem.php"><i class="icon-large icon-leaf"></i> Featured (Store, Product)</a></li>
                          <li><a href="createitempic.php"><i class="icon-large icon-camera"></i> Picture (Store, Product)</a></li>
                          <li><a href="createuser.php"><i class="icon-large icon-user"></i> Users</a></li>
                          <li><a href="createtraffic.php"><i class="icon-large icon-road"></i> Traffics</a></li>
                          <li><a href="createreview.php"><i class="icon-large icon-pencil"></i> Reviews</a></li>
                          <li><a href="createpush.php"><i class="icon-large icon-envelope"></i> Push Message</a></li>
                        </ul>
                      </li>
                    </ul>
