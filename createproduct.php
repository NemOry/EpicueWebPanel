...
<div class="container-fluid">
  <div class="row-fluid">
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <div class="fileupload fileupload-new" data-provides="fileupload">
              <div class="fileupload-new thumbnail" style="width: height: 200px;"><img src="public/img/thumbnail.png" /></div>
    ...
    <div class="span6 well" style="max-height:600px; height:600px; overflow:scroll;">
      <legend>
          Products <button onclick="loadtable(); return false;" class="btn btn-mini btn-success"><i class="icon-large icon-refresh icon-white"></i></button> <span id="loading" class="label">Loading...</span>
      </legend>
  ...
  function loadtable()
  {
    ...
    $.ajax(
    {
      url: 'includes/webservices/gettable.php?itemtype=product&input='+$("#tablesearch").val(),
  ...
  $(document).on("click", ".btndelete", function()
  {
    ...
    {
      type: 'get',
      url: 'includes/webservices/delete.php?itemid='+id+'&itemtype=product',
      success: function(result) 
      {
        loadtable();
      }
  ...
  { 
    ...
    $("#btncreate").click(function()
    {
      ...
      {
        type: 'POST',
        url: 'includes/webservices/createproduct.php',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
