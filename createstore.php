...
<div class="container-fluid">
  <div class="row-fluid">
    <div class="span5">
      <form id="theform" class="form-horizontal" method="post" action="#" enctype="multipart/form-data">
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <input id="branchname" name="branchname" type="text" placeholder="branch name" class="input-xlarge">
          </div>
        </div>
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <textarea id="address" name="address" class="span8"  placeholder="address" style="width:285px; height:100px"></textarea>
          </div>
        </div>
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <input id="longitude" name="longitude" type="text" placeholder="longitude" class="input-xlarge">
          </div>
        </div>
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <input id="latitude" name="latitude" type="text" placeholder="latitude" class="input-xlarge">
          </div>
        </div>
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <input id="telnum" name="telnum" type="text" placeholder="telephone #" class="input-xlarge">
          </div>
        </div>
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <input id="deliverynum" name="deliverynum" type="text" placeholder="delivery #" class="input-xlarge">
          </div>
        </div>
          ...
          <div class="controls">
            <select name="storetypeid" id="storetypeid">
              ...
              if(count($storetypes) > 0)
              {
                ...
                {
                  echo "<option value='".$storetype->id."'>".$storetype->name."</option>";
                }
              }
              else
              {
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <input id="facebookid" name="facebookid" type="text" value="0" placeholder="Facebook ID" class="input-xlarge">
          </div>
        </div>
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <input id="twitterid" name="twitterid" type="text" value="0" placeholder="Twitter ID" class="input-xlarge">
          </div>
        </div>
    ...
    <div class="span6 well" style="max-height:600px; height:600px; overflow:scroll;">
      <legend>
          Stores <button onclick="loadtable(); return false;" class="btn btn-mini btn-success"><i class="icon-large icon-refresh icon-white"></i></button> <span id="loading" class="label">Loading...</span>
      </legend>
  ...
  function loadtable()
  {
    ...
    $.ajax(
    {
      url: 'includes/webservices/gettable.php?itemtype=store&input='+$("#tablesearch").val(),
  ...
  $(document).on("click", ".btndelete", function()
  {
    ...
    {
      type: 'get',
      url: 'includes/webservices/delete.php?itemid='+id+'&itemtype=store',
      success: function(result) 
      {
        loadtable();
      }
  ...
  { 
    ...
    $("#btncreate").click(function()
    {
      ...
      {
        type: 'POST',
        url: 'includes/webservices/createstore.php',
        data: formData,
        cache: false,
        contentType: false,
        processData: false,
