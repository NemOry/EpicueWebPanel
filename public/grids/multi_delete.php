...
if($what == "user")
{
	...
	$log = new Log($session->userid, $clientip, "WEB", "DELETED MULTIPLE USERS"); $log->create();
...
else if($what == "school")
{
	...
	$log = new Log($session->userid, $clientip, "WEB", "DELETED MULTIPLE SCHOOLS"); $log->create();
	$response = "success";
}
else if($what == "schooluser")
{
	...
	$log = new Log($session->userid, $clientip, "WEB", "DELETED MULTIPLE SCHOOLUSERS"); $log->create();
	$response = "success";
}
else if($what == "batch")
{
	...
	$log = new Log($session->userid, $clientip, "WEB", "DELETED MULTIPLE BATCHS"); $log->create();
...
else if($what == "batchuser")
{
	...
	$log = new Log($session->userid, $clientip, "WEB", "DELETED MULTIPLE BATCHUSERS"); $log->create();
	$response = "success";
}
else if($what == "section")
{
	...
	$log = new Log($session->userid, $clientip, "WEB", "DELETED MULTIPLE SECTIONS"); $log->create();
	$response = "success";
}
else if($what == "sectionuser")
{
	...
	$log = new Log($session->userid, $clientip, "WEB", "DELETED MULTIPLE SECTIONUSERS"); $log->create();
	$response = "success";
}
else if($what == "pending")
{
	...
	$log = new Log($session->userid, $clientip, "WEB", "DELETED MULTIPLE PENDINGS"); $log->create();
	$response = "success";
}
else if($what == "log")
{
	...
	$log = new Log($session->userid, $clientip, "WEB", "DELETED MULTIPLE LOGS"); $log->create();
	$response = "success";
}
else if($what == "hit")
{
	...
	$log = new Log($session->userid, $clientip, "WEB", "DELETED MULTIPLE HITS"); $log->create();
	$response = "success";
}
