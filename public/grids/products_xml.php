...
if(isset($_GET['searchString']) && isset($_GET['searchField']) && isset($_GET['searchOper']))
{
    ...
    $objects = Product::get_by_sql("SELECT * FROM ".T_PRODUCTS." WHERE ".$where." ORDER BY $sidx $sord LIMIT $start , $limit");
}
else
{
    $objects = Product::get_by_sql("SELECT * FROM ".T_PRODUCTS." ORDER BY $sidx $sord LIMIT $start , $limit");
}
...
foreach($objects as $object) 
{
    ...
    $s .= "<cell>". $object->description."</cell>";
    $s .= "<cell>". $object->price."</cell>";
    $s .= "<cell>". $object->producttypeid."</cell>";
