...
<div class="row-fluid">
  ...
  <div class="span9">
    <form id="theform" class="form-horizontal" action="#" method="post" enctype="multipart/form-data">
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <div class="fileupload fileupload-new" data-provides="fileupload">
              ...
              <div class="fileupload-preview fileupload-exists thumbnail" style="200px; max-height: 200px; line-height: 20px;"></div>
              <div>
      ...
      <input type="hidden" name="storetypeid" value="<?php echo $object->id; ?>" />
...
$(function () 
{
  ...
  $("#btnsave").click(function()
  {
    ...
    {
      type: 'POST',
      url: 'includes/webservices/updatestoretype.php',
      data: formData,
      cache: false,
      contentType: false,
      processData: false,
